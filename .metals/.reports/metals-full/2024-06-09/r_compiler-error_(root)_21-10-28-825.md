file://<WORKSPACE>/src/main/scala/test2.scala
### java.lang.IndexOutOfBoundsException: 47
...
action parameters:
offset: 41
uri: file://<WORKSPACE>/src/main/scala/test2.scala
text:
```scala
import chisel3._
...
scala.reflect.internal.util.BatchSourceFile.offsetToLine(SourceFile.scala:201)
	...
	scala.meta.internal.pc.ScalaPresentationCompiler.$anonfun$documentHighlight$1(ScalaPresentationCompiler.scala:387)
```
#### Short summary: 
