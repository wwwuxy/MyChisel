...
//for top
        io.out,jump_jalr := Contorller.io.jump_jalr
        io.out,jump_en := Contorller.io.jump_en
        io.out,imm := Contorller.io.imm
        io.out,is_ecall := Contorller.io.is_ecall
        io.out,is_mret := Contorller.io.is_mret
        io.out,mtvec := RegisterFile.io.mtvec
        io.out,epc := RegisterFile.io.epc
        io.out,@@rd1 := RegisterFile.io.rd1
    }
